...
public interface PersonMapper {
    ...
    @Mapping(source = "medical_registry", target = "medicalRegistry")
    ...
    @Mapping(source = "id_document_type", target = "personEntityDoctor.documentType.id")
    ...
    @Mapping(source = "id_document_type", target = "personEntityShipper.documentType.id")
    ...
    @Mapping(source = "id_document_type", target = "personEntityAgent.documentType.id")
